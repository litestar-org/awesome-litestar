...
| Project   |     | Status                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
|-----------|:----|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| CI/CD     |     | [![ci](https://github.com/litestar-org/awesome-litestar/actions/workflows/ci.yaml/badge.svg)](https://github.com/litestar-org/awesome-litestar/actions/workflows/ci.yaml) [![Link Check](https://github.com/litestar-org/awesome-litestar/actions/workflows/expired-links.yaml/badge.svg?branch=main)](https://github.com/litestar-org/awesome-litestar/actions/workflows/expired-links.yaml)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
